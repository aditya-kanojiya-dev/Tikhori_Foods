...
export default function FarmToJar() {
  ...
  return (
    <section id="process" className="relative bg-warm-white overflow-hidden">
      {/* Header */}
      <div ref={headerRef} className="py-24 md:py-32 pb-12 md:pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-saffron text-sm uppercase tracking-[0.3em] font-semibold">Our Process</span>
      ...
      {/* Scrollytelling */}
      <div ref={containerRef} className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
            ...
            <div className="sticky top-32">
              <div className="relative w-64 h-80 mx-auto">
                ...
                <svg viewBox="0 0 200 300" className="w-full h-full">
                  ...
                  <text x="100" y="178" textAnchor="middle" fill="#C41E22" fontSize="14">🌶️</text>
                </svg>
                ...
                >
                  <motion.span>
                    {/* We'll just show a simple indicator */}
                  </motion.span>
                </motion.div>
              </div>
            </div>
  ...
  return (
    ...
    >
      ...
      {index < steps.length - 1 && (
        <div className="absolute left-8 top-20 bottom-[-3rem] w-[2px] bg-gradient-to-b from-gold/30 to-transparent hidden lg:block" />
      )}

      <div className="flex gap-6">
        {/* Step number */}
        <div className={`shrink-0 w-16 h-16 rounded-full ${step.color} flex items-center justify-center text-white font-display text-xl font-bold shadow-lg`}>
          {step.emoji}
        </div>
